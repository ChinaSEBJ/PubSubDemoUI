<!--
 * @Author: Jeff Liu
 * @Date: 2023-05-22 14:55:37
 * @LastEditTime: 2023-05-22 17:40:15
 * @LastEditors: Jeff Liu
 * @Description: 
 * @FilePath: /PubSubDemoUI/src/page/subscriber/components/searchItem.vue
  ...
  <div class="search_container searchArea">
        <el-form 
            ...
            <el-form-item class="btnRight">
                ...
                <el-button type="primary" size ="mini" icon="view" @click='onAddMoney()'>添加订阅者</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
