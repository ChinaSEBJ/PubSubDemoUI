<!--
 * @Author: Jeff Liu
 * @Date: 2023-05-22 17:13:16
 * @LastEditTime: 2023-05-22 22:25:17
 * @LastEditors: Jeff Liu
 * @Description: 
 * @FilePath: /PubSubDemoUI/src/page/subscriber/subscribers.vue
    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            <el-table v-loading="loading" :data="tableData" style="width: 100%" align='center' @select="selectTable" @select-all="selectAll">
                ...
                <el-table-column prop="SubscriberName" label="订阅者名称" align='center'>
                </el-table-column>
                <el-table-column prop="Target" label="订阅者平台组件" align='center'>
                </el-table-column>
                <el-table-column prop="ID" label="订阅者ID" align='center'>
                </el-table-column>
    ...
    methods: {
        ...
        onDeleteMoney(row) {
            this.$confirm('确认删除该记录吗?', '提示', {
                ...
                .then(() => {
                    axios
                    .delete('/hcc/pubsub/removesubscriber/' + row.ID)
                    .then(response => {
